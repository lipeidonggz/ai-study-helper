...
- 下一步：人工标注 CSV（backend/eval/reports/annotate-20260805-090814.csv，填 answer_correct/refusal）→ 补 stream_complete/latency_budget criteria → 获取并固定《三国演义》txt → prompt 策略对比
